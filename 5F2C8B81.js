...
function myFunction2() { 
    document.getElementById("mp4").src = "https://drive.google.com/uc?id=120DbceUz0SNvYWfxz_iMqi56a2ZnU-ve&export=download";
    document.getElementById("video").load();
...
function myFunction3() { 
    document.getElementById("mp4").src = "https://drive.google.com/uc?id=1pJXNzjQO9VzPdHdGZk_8l0X_5XX4j4ib&export=download";
    document.getElementById("video").load();
...
function myFunction4() { 
    document.getElementById("mp4").src = "https://drive.google.com/uc?id=10w8NKacvpyO-QWyoAfPmmhtyPYGL2CtJ&export=download";
    document.getElementById("video").load();
