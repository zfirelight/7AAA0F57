...
function myFunction2() { 
    document.getElementById("mp4").src = "https://drive.google.com/uc?id=1JupfXmIWVktAeALDcEi1LMOg4uq-Z7MY&export=download";
    document.getElementById("video").load();
...
function myFunction3() { 
    document.getElementById("mp4").src = "https://drive.google.com/uc?id=1Jh_rOYsOYuLZlIJ_YKzfM5Mj524HyXRw&export=download";
    document.getElementById("video").load();
...
function myFunction4() { 
    document.getElementById("mp4").src = "https://drive.google.com/uc?id=16AfR-oVpiq7m9FwWgd7xxZhalEPCIITw&export=download";
    document.getElementById("video").load();
